...
function createPuzzle() {
    ...
    result.held = held;
    result.disable_hold = document.getElementById("hold").checked;
    result.fourwide = document.getElementById("4wide").checked;
    result.completions = 0;
    result.plays = 0;
    result.season = document.getElementById("season").value;
    result.description = document.getElementById("description").value;
    result.infinite_t = true;
  ...
  http.open("POST", "create.php?difficulty="+document.getElementById("difficulty").value+"&password="+password+"&name="+document.getElementById("puzzlename").value, true);
